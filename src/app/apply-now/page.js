            ...
            <div className="space-y-8">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <a href="tel:+918883335553" className="text-lg font-semibold hover:text-yellow-400">
                    +91 88833 35553
                  </a>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <a href="mailto:littlemelody0000@gmail.com" className="text-lg font-semibold hover:text-yellow-400 break-all">
